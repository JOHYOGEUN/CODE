...
git clone ~~깃허브 주소~~ ./ main

https://www.toptal.com/developers/gitignore 에서 csharp 검색*

main 파일안에 메모장으로 확장자 txt 지우고 .gitignore파일 생성후 깃이그노어 내용 복사 붙여넣기*



소스 코드에 add 에서 main 폴더 지정


main 폴더 우클릭하여 깃배쉬 접속

$ git config --global user.name "JOHYOGEUN"
$ git config --global user.email johg940929@gmail.com

JOHYOGEUN
johg940929@gmail.com
